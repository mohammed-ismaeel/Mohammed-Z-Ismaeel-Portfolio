      ...
      <div className="heading flex justify-between">
        ...
        <div className="pagination flex gap-3">
          <button
            ...
            className="group w-12 h-12 glass-panel rounded-xl border border-blue/20 flex items-center justify-center hover:border-blue/40 hover:shadow-[0_0_40px_rgba(56,189,248,0.3)] transition-all duration-300 hover:scale-110 hover:-translate-y-1"
          >
            <FontAwesomeIcon
              icon="fa-solid fa-chevron-left"
              className="text-blue text-xl group-hover:-translate-x-0.5 transition-transform duration-300"
            />
          </button>
          <button
        ...
        <main className="slider-main-container max-lg:w-full">
          ...
          >
            {MyProjects?.map((ele, index) => (
              <SwiperSlide
                key={index}
                className={isMobile ? "w-[85%] max-w-[320px]" : "w-1/3 bg-white"}
              >
