...
const Services = () => {
  ...
  return (
    <section
      ref={ref}
      className="services w-4/5 mx-auto my-0 py-36 px-0 max-xl:py-28 max-lg:py-24 max-sm:py-20 max-sm:w-11/12"
      id="Services"
    >
      <motion.h1
        className="text-white text-center text-4xl font-black pb-6 tracking-[-0.04em] max-lg:text-3xl max-sm:text-2xl"
      ...
      <div className="cards flex justify-between gap-6 mt-12 flex-wrap max-xl:justify-center max-lg:gap-4 max-sm:gap-3 items-stretch">
        {[
          {
          ...
          <motion.div
            ...
            className="w-[22%] min-w-60 max-xl:w-[45%] max-lg:w-[45%] max-sm:w-full max-xl:flex max-xl:justify-center h-full flex flex-col"
